...
Auth::require();
$ilpf = (new IlpfData(Auth::id()))->build('aku-janji');
...
function App() {
  return (
    <Shell activeKey="utama" context="Aku Janji" logoutUrl="logout.php">
      <AkuJanji variant="v2" apiBase="api/" />
    </Shell>
  );
}
